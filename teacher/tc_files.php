...
-->
	...
	<iframe id="attanCanvas" name="attanCanvas" style="position: absolute; padding: 10px; width: 75%; height: 100%; border: none; overflow:hidden;" src="../tc_file_list.php"></iframe>
	
	<div style="position: absolute; width: 22%; right: 0; margin: 0; padding-top: 20px" align="right">
		<a href="../tc_file_upload.php" target="attanCanvas"><input type="button" value="Upload file" class="butatt"></input></a><br><br>
		<a href="../tc_file_list.php" target="attanCanvas"><input type="button" value="List file" class="butatt"></input></a><br><br>
	</div>
</body>
</html>